...
class Net(hk.Module):
  ...
  def _msg_passing_step(self,
    ...
    hiddens, output_preds_cand, hint_preds, lstm_state, hidden_edge= self._one_step_pred(
    ...
    accum_mp_state = _MessagePassingScanState(  # pytype: disable=wrong-arg-types  # numpy-scalars
        ...
        hiddens=None, lstm_state=None, hidden_edge=None)
  ...
  def __call__(self, features_list: List[_Features], repred: bool,
    ...
    for algorithm_index, features in zip(algorithm_indices, features_list):
      ...
      mp_state = _MessagePassingScanState(  # pytype: disable=wrong-arg-types  # numpy-scalars
          ...
          hiddens=hiddens, lstm_state=lstm_state, hidden_edge=None)
    ...
    return output_preds, hint_preds, output_mp_state
  ...
  def _one_step_pred(
    ...
    return nxt_hidden, output_preds, hint_preds, nxt_lstm_state, nxt_edge
...
class NetChunked(Net):
  ...
  def _msg_passing_step(self,
    ...
    if self.use_lstm:
      ...
      lstm_state = None
    hiddens, output_preds, hint_preds, lstm_state, hidden_edge= self._one_step_pred(
    ...
    new_mp_state = MessagePassingStateChunked(  # pytype: disable=wrong-arg-types  # numpy-scalars
        ...
        inputs=nxt_inputs, hints=nxt_hints, is_first=nxt_is_first, hidden_edge=hidden_edge)
